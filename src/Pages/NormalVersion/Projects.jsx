...
const Projects = () => {
    ...
    return (
        <section ref={projectsref} className='py-12! bg-teal-300'><h1>help founders to convert<br />ideas into digital<br />experience</h1>
            <div className='perspective-[850px] h-230 relative'>
